...
public class SecteurIntegrationTest {
    private static Logger logger = LogManager.getLogger(SecteurIntegrationTest.class);
    /**
     ...
     * Make sure that in your database One secteur exists with this ID
     */
    private int secteurId = 1;



    /**
     * This method get a pivot secteur with the given id
     * @see Secteur#id
     * <b>
    ...
    public void getSecteurWSById() throws Exception{

        String getSecteurByIdURI = BASE_URI+SECTEUR_PATH+"/"+secteurId;
    ...
    /**
     * Get All the secteurs in pivot
     * If every done , it will return a 200 httpStatus code
     * @throws Exception
     */
    @Test(priority = 1, groups = {"SecteurTest"})
    public void getAllSecteursWS()throws Exception{
