 ...
 * the methods :
 * <ul>
 * <li>get one pilier with the it's axes secteurs and projets by it's id</li>
 * <li>get all pilier with the theirs axes secteurs and projets</li>
 * </ul>
...
public class PilierIntegrationTest {
    private static Logger logger = LogManager.getLogger(PilierIntegrationTest.class);
    /**
     ...
     * Make sure that in your database One pilier exists with this ID
     */
    private int pilierId = 1;



    /**
     * This method get a pivot pilier with the given id
     * @see Pilier#id
     * <b>
    ...
    public void getPilierWSById() throws Exception{

        String getPilierByIdURI = BASE_URI+PILIER_PATH+"/"+pilierId;
